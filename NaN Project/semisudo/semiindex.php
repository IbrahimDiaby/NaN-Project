<?php
    ...
    if(isset($_POST['mail']) && isset($_POST['password'])){
        if(!empty($_POST['mail']) && !empty($_POST['password'])){
            $req=$db->prepare("SELECT * FROM SemiSudo WHERE Mail = ? AND Password = ?");
...
<head>
    ...
    <title>Connexion Semi Administrateur</title>
    <link rel="stylesheet" href="semiheader.css" type="text/css">
    <link rel="stylesheet" href="semisection.css" type="text/css">
    <link rel="stylesheet" href="semifooter.css" type="text/css">
    <script src="semiindex.js"></script>
</head>
<body>
    <header>
        <div id="logo">
