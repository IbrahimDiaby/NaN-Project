<?php
    ...
    $requete->execute(array(htmlspecialchars($_POST['name']), htmlspecialchars($_POST['surname']), htmlspecialchars($_POST['old']), htmlspecialchars($_POST['mail']), htmlspecialchars($_POST['locate']), htmlspecialchars($_POST['activity']), htmlspecialchars($_POST['group']), htmlspecialchars($_POST['equipe']), htmlspecialchars($_GET['ID'])));
...
<head>
    ...
    <title>Modifier les informations d'un Etudiant</title>
</head>
<body>
    <header>
        <div id="logo">
